...
import GitHubIcon from 'bigCommerceComponents/icons/github';
import FooterMenu from 'bigCommerceComponents/layout/footer-menu';
import LogoSquare from 'bigCommerceComponents/logo-square';
