            ...
            {menu.map((item, index) => (
              ...
              >
                {item?.hasChildren ? (
                  <Link
                    href={item.path}
                    className={`text-mediumGray flex items-center gap-[9px] border-b-[2px] border-white text-[14px] font-bold ${
                      active == item && 'active'
                  ...
                  <Link
                    href={item.path}
                    className="text-mediumGray group-hover:border-teal group-hover:text-teal flex items-center gap-[9px] border-b-[2px] border-white text-[14px] font-bold"
                  >
                    {item.title}
                  </Link>
                )}
                        ...
                        item.children.map((subItem, index) => {
                          ...
                          return (
                            (previousItem?.hasChildren || !previousItem || subItem.hasChildren) && (
                              ...
                              >
                                <Link
                                  className="text-teal block text-[16px] font-bold"
                                  href={subItem.path}
                                >
                                  {subItem.title}
                                </Link>
